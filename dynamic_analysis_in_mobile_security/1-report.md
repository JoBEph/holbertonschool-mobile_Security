...
Analyse Statique : Utilisation de jadx pour identifier la méthode native getSecretMessage() dans MainActivity.java. L'analyse du code source Java a confirmé l'existence d'une logique de déchiffrement native.

Désassemblage et Identification : Utilisation de objdump et d'un éditeur hexadécimal pour localiser la section .rodata du fichier .so. L'algorithme de déchiffrement a été isolé par lecture du code binaire : une soustraction cyclique basée sur une séquence de Fibonacci.
